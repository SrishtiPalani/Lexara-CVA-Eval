export const models = [
   ...
   // Salesforce EinsteinCustomGPT via LLM Gateway
   { value: "my-finetuned", label: "my-finetuned" }
];
...
export const testCaseMapping: Record<string, {
  ...
  "demo_tests-tc.v2.yaml":  { title: "Conference Registrations", difficulty: "Easy", domain: "Customer Support", datasource: "demo_tests-ds.v2.yaml" },
